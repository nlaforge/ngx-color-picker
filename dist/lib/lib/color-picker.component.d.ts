...
export declare class ColorPickerComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    cpWidth: number;
    cpHeight: number;
    cpSliderSLHeight: number;
    cpSliderSLWidth: number;
    cpColorMode: number;
    cpCursorRadius: number;
