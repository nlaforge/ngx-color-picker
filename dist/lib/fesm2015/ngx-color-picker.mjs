...
import { EventEmitter, Directive, Input, Output, HostListener, Injectable, Component, PLATFORM_ID, ViewEncapsulation, Inject, ViewChild, Injector, NgModule } from '@angular/core';
...
class ColorPickerComponent {
    ...
    ngOnInit() {
        ...
        this.sliderDimMax = new SliderDimension(hueWidth, this.cpSliderSLWidth, this.cpSliderSLHeight, alphaWidth);
    ...
    ngAfterViewInit() {
        if (this.cpWidth !== 230 || this.cpDialogDisplay === 'inline') {
            const hueWidth = this.hueSlider.nativeElement.offsetWidth || 50;
            const alphaWidth = this.alphaSlider.nativeElement.offsetWidth || 50;
            this.sliderDimMax = new SliderDimension(hueWidth, this.cpSliderSLWidth, this.cpSliderSLHeight, alphaWidth);
    ...
    setupDialog(instance, elementRef, color, cpWidth, cpHeight, cpSliderSLHeight, cpSliderSLWidth, cpCursorRadius, cpDialogDisplay, cpFallbackColor, cpColorMode, cpCmykEnabled, cpAlphaChannel, cpOutputFormat, cpDisableInput, cpIgnoredElements, cpSaveClickOutside, cpCloseClickOutside, cpUseRootViewContainer, cpPosition, cpPositionOffset, cpPositionRelativeToArrow, cpPresetLabel, cpPresetColors, cpPresetColorsClass, cpMaxPresetColorsLength, cpPresetEmptyMessage, cpPresetEmptyMessageClass, cpOKButton, cpOKButtonClass, cpOKButtonText, cpCancelButton, cpCancelButtonClass, cpCancelButtonText, cpAddColorButton, cpAddColorButtonClass, cpAddColorButtonText, cpRemoveColorButtonClass, cpEyeDropper, cpTriggerElement, cpExtraTemplate) {
        ...
        this.cpSliderSLHeight = parseInt(cpSliderSLHeight, 10);
        this.cpSliderSLWidth = parseInt(cpSliderSLWidth, 10);
        this.cpCursorRadius = parseInt(cpCursorRadius, 10);
    ...
    updateColorPicker(emit = true, update = true, cmykInput = false) {
        if (this.sliderDimMax) {
            ...
            this.slider = new SliderPosition((this.sliderH || this.hsva.h) * this.sliderDimMax.h - this.cpCursorRadius, this.hsva.s * this.sliderDimMax.s - this.cpCursorRadius, (1 - this.hsva.v) * this.sliderDimMax.v - this.cpCursorRadius, this.hsva.a * this.sliderDimMax.a - this.cpCursorRadius);
...
class ColorPickerDirective {
    ...
    openDialog() {
        ...
        if (!this.dialogCreated) {
            ...
            const cpSliderWidth = (_a = this.cpSliderSLWidth) !== null && _a !== void 0 ? _a : this.cpWidth;
